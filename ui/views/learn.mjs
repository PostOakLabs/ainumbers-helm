...
export async function renderLearn(root) {
  root.innerHTML = `
    ...
    <section class="card" aria-labelledby="learn-pairing">
      ...
      <p>Helm starts automatically and a freshly paired tab opens on its own — reopen it from your login items or Start menu if you lost it, or use <a href="#/operate">Operate</a>'s advanced pairing form to reconnect this tab by hand.</p>
