...
// PACK-MARKER-COMPILE-1 (PACK-MARKER-BUILD-SPEC.md §4, §6, §9 row 2) piloted
// the BaaS & Embedded Finance domain's 5 chains. PACKMARKER-EXTEND-97-1
// widens to the full live skip list re-derived from the compiler at
// authorship time (was 5, now 5 + the 97 chains --check reported skipped) —
// every step in every added chain confirmed a genuine browser tool via
// isConfirmedBrowserTool before landing (see the row's check-off evidence).
const MARKER_PILOT_CHAINS = new Set([
  ...
  "basel-endgame-frtb-capital",
  "basel-iv-capital-stress",
  "bnpl-programme",
  "bond-mandate-receipt",
  "card-interchange",
  "card-programme",
  ...
  "digital-trade-counterparty-aml",
  "dlt-network-governance",
  "dlt-settlement-compliance",
  ...
  "insurance-capital-pricing",
  "iso20022-cross-border-readiness",
  "iso20022-cutover",
  "kyc-onboarding-cdd",
  "marketplace-platform-payments",
  "mcp-publish-readiness",
  "mcp-security-hardening",
  "mica-passporting-surveillance",
  ...
  "stablecoin-issuer-genius-mica",
  "stablecoin-reserve",
  "sustainability-disclosure-sfdr",
  "t1-csdr-settlement",
  "trade-finance-lc-lifecycle",
