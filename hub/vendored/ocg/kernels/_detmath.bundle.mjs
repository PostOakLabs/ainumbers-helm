...
export const exp = _detmath.exp;
export const log = _detmath.log;
export const log2 = _detmath.log2;
export const sin = _detmath.sin;
export const cos = _detmath.cos;
export const tan = _detmath.tan;
export const pow = _detmath.pow;
export const PI = _detmath.PI;
export const E = _detmath.E;
export default _detmath;
