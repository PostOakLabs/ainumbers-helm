...
export const CLOSED_OPERATORS = _dtree.CLOSED_OPERATORS;
export const MAX_DEPTH = _dtree.MAX_DEPTH;
export const MAX_NODES = _dtree.MAX_NODES;
export const MAX_TREE_BYTES = _dtree.MAX_TREE_BYTES;
export const validateTree = _dtree.validateTree;
export const evalOperator = _dtree.evalOperator;
export const computeTreeDigest = _dtree.computeTreeDigest;
export const runTree = _dtree.runTree;
export default _dtree;
