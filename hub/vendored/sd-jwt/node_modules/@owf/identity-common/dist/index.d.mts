...
declare const concatBytes: (...byteArrays: Array<Uint8Array>) => Uint8Array<ArrayBuffer>;
...
//#endregion
//#region src/hex.d.ts
declare const hexEncode: (input: Uint8Array) => string;
declare const hexDecode: (input: string) => Uint8Array;
declare const hex: {
  encode: (bytes: Uint8Array) => string;
  decode: (hex: string) => Uint8Array;
};
//#endregion
//#region src/identity-exception.d.ts
/**
 ...
 */
declare class IdentityException extends Error {
  details?: unknown;
  constructor(message: string, details?: unknown);
  getFullMessage(): string;
}
//#endregion
//#region src/identity-common-exception.d.ts
/**
 * IdentityCommonException is a custom error class for identity-common-related exceptions.
 */
declare class IdentityCommonException extends IdentityException {
  constructor(message: string, details?: unknown);
}
//#endregion
