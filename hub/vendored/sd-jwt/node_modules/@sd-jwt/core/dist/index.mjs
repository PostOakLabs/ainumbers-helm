...
// src/index.ts
function validateReservedFieldsInternal(payload) {
  const reservedFields = /* @__PURE__ */ new Set([SD_DIGEST, "_sd_alg", SD_DECOY, SD_LIST_KEY]);
  const visit = (node) => {
...
var _SDJwtInstance = class _SDJwtInstance {
  ...
  validateReservedFields(payload) {
    validateReservedFieldsInternal(payload);
  }
